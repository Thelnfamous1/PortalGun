...
public class IntBoxHelper {
    public static CompoundTag toTag(IntBox intBox) {
        ...
        tag.putInt("lX", intBox.l.getX());
        tag.putInt("lY", intBox.l.getY());
        tag.putInt("lZ", intBox.l.getZ());

        tag.putInt("hX", intBox.h.getX());
        tag.putInt("hY", intBox.h.getY());
        tag.putInt("hZ", intBox.h.getZ());
